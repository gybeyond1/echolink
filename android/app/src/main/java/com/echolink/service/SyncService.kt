...
import com.echolink.ui.MainActivity
...
class SyncService : Service(), WebSocketClient.WsEventListener {
    ...
    override fun onCreate() {
        ...
        com.echolink.data.P2pManager.init(this)
    ...
    override fun onMessage(type: String, data: JSONObject?, topic: String?) {
        ...
        when (type) {
            ...
            "friend_request" -> {
                ...
                sendBroadcast(Intent("com.echolink.REQUESTS_CHANGED"))
                sendBroadcast(Intent("com.echolink.FRIENDS_CHANGED"))
            }
            ...
            "p2p" -> {
                ...
                if (payload != null && topic != null) {
                    val intent = Intent("com.echolink.P2P_SIGNAL").apply {
            ...
            "profile_updated" -> {
                ...
                sendBroadcast(Intent("com.echolink.PROFILE_CHANGED"))
            }
            ...
            "message_deleted" -> {
                ...
                if (t.isNotEmpty() && mid > 0) {
                    val intent = Intent("com.echolink.MESSAGE_DELETED").apply {
                        putExtra("topic", t)
    ...
    private fun handleSyncedNotification(data: JSONObject?) {
        ...
        // 发送广播通知 UI 更新
        val broadcastIntent = Intent("com.echolink.NOTIFICATION_RECEIVED").apply {
    ...
    private fun handleMessageRead(topic: String?, data: JSONObject?) {
        ...
        val intent = Intent("com.echolink.MESSAGE_READ").apply {
            putExtra("topic", topic)
